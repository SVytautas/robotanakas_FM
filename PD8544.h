...
#define PCD8544_SCK_PIN                     GPIO_PIN_5
#define PCD8544_SCK_GPIO_PORT               GPIOA
#define PCD8544_SCK_AF                      GPIO_AF5_SPI1
//MOSI PIN PA7 SPI1
#define PCD8544_MOSI_GPIO_CLK_ENABLE()      __HAL_RCC_GPIOA_CLK_ENABLE()
#define PCD8544_MOSI_PIN                    GPIO_PIN_7
#define PCD8544_MOSI_GPIO_PORT              GPIOA
#define PCD8544_MOSI_AF                     GPIO_AF5_SPI1
 


//CE pin PE7
#define PCD8544_SS_GPIO_CLK_ENABLE()       __HAL_RCC_GPIOE_CLK_ENABLE() 
#define PCD8544_SS_PIN                     GPIO_PIN_7//GPIO_PIN_3
#define PCD8544_SS_GPIO_PORT               GPIOE //GPIOC

//RST pin PA6
#define PCD8544_RST_CLK_ENABLE()					__HAL_RCC_GPIOA_CLK_ENABLE()
#define PCD8544_RST_PORT									GPIOA
#define PCD8544_RST_PIN										GPIO_PIN_6

//DC pin PC5
#define PCD8544_DC_RCC()									__HAL_RCC_GPIOC_CLK_ENABLE()	
#define PCD8544_DC_PORT										GPIOC
...
//SPI papildomos funkcijos
#define PCD8544_FORCE_RESET()               __HAL_RCC_SPI1_FORCE_RESET()
#define PCD8544_RELEASE_RESET()             __HAL_RCC_SPI1_RELEASE_RESET()

#define PCD8544_CE_LOW				HAL_GPIO_WritePin(PCD8544_SS_GPIO_PORT, PCD8544_SS_PIN, GPIO_PIN_RESET);
#define PCD8544_CE_HIGH				HAL_GPIO_WritePin(PCD8544_SS_GPIO_PORT, PCD8544_SS_PIN, GPIO_PIN_SET);

#define PCD8544_IRQn                        SPI1_IRQn
#define PCD8544_IRQHandler                  SPI1_IRQHandler
/**
 * Private enums
 */
typedef enum {
...
extern void NOKIA_PRINTF(const char *fmt, ...);
extern void PCD8544_fillbuff(char * buff);
...
//pvz..
 ...
 //   PCD8544_GotoXY(45, 42);
	...
	// PCD8544_Puts("x: 12345", PCD8544_Pixel_Set, PCD8544_FontSize_3x5);
    
    //Display data on LCD
  //  PCD8544_Refresh();
	//PCD8544_GotoXY(45, 42);
    //Put string with Pixel set mode and Fontsize of 3x5
	// PCD8544_Puts("x: 2222345", PCD8544_Pixel_Set, PCD8544_FontSize_3x5);
//	   PCD8544_Refresh();
